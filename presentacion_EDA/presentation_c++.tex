...
%---------------------------------------------------------------------------------------- 
\begin{frame} 
\frametitle{Time Analysis} 
\begin{center} 
\begin{tabular}{l l @{\hspace{0.8cm}}p{1cm}}
\cline{2-2} 
\toprule 
\textbf{Data Estructure} & \textbf{Runtime(seconds)} \\ 
\midrule
Stack & 4\\ Double linked list & 38\\ Queue & 3\\ 
\bottomrule 
\end{tabular} 
\end{center} 
\end{frame} %--------------------------------------------------
...
\begin{figure}
\includegraphics[totalheight=2cm]{1.png}
\end{figure}


Orden de Complejidad es de O($n^{2}$)
